...
class ag_settings_engine {
	public $css_prefix 	= 'ag_'; // prefix added to classes for customized styling
	public $ml_key 		= 'ag_ml'; // multilanguage key
		...
		?>	
			...
			jQuery(document).on(
            	...
            	function(e) {
                    ...
                    var $field_wrap = jQuery('[name='+ e.data.field_id +'], [name="'+ e.data.field_id +'[]"]').parents('tr');
                    var show = true;
